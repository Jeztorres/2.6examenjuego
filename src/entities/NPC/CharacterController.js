...
export default class CharacterController extends Component{
    constructor(model, clips, scene, physicsWorld){
        ...
        this.canMove = true;
        this.maxHealth = 50; // Reducir vida máxima para que sea más fácil
    ...
    TakeHit = msg => {
        // Aumentar el daño recibido para que sea más fácil de matar
        const damage = msg.amount * 2; // Doble daño
