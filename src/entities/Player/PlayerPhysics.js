...
export default class PlayerPhysics extends Component{
    ...
    Initialize(){
        ...
        // Añadir el jugador con grupo específico para asegurar detección por triggers
        this.world.addRigidBody(this.body, CollisionFilterGroups.DefaultFilter, CollisionFilterGroups.AllFilter);
    }
